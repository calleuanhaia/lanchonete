    ...
    <aside id="sidebar" class="bg-slate-900 text-white w-64 flex-shrink-0 fixed md:static inset-y-0 left-0 transform -translate-x-full md:translate-x-0 z-30 flex flex-col shadow-2xl">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            <ul class="space-y-1 px-3">
                ...
                <?php if ($tipo === 'gestor'): ?>
                    <li>
                    <a href="index.php?page=lista_funcionarios_2.php" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors">
                        <i class="ph ph-users"></i>
                        <span class="font-medium">Funcionarios</span>
                    </a>
                    </li>
                    <li>
                    <a href="index.php?page=lista_pagamento.php" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors">
