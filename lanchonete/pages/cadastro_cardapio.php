<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-xl mx-auto mt-6">
    ...
    <form method="POST" action="api/cadastrar_cardapio.php" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" oninput="this.value = this.value.replace(/,/g, '.')" name="preco" placeholder="Ex: R$ 3,35, 5,50..." class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5">Preço da Bebida</label>
            <input type="text" oninput="this.value = this.value.replace(/,/g, '.')" name="preco_b" placeholder="Ex: R$ 3,35, 5,50..." class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all">
        </div>
