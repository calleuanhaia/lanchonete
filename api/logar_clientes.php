<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        try {
            ...
            $selecionar = "SELECT nome, email, endereco FROM clientes WHERE nome = :nome AND senha = :senha or email = :email";
            ...
            if($usuario){
                ...
                $_SESSION['usuario_tipo'] = 'cliente'; // Identifica de onde veio
